...
public class MainWindow extends JFrame implements ActionListener, ComponentListener{
	...
	LabelTextFieldPanel user = new LabelTextFieldPanel("Anv�ndare: ");
	LabelTextFieldPanel pass = new LabelTextFieldPanel("L�senord: ", true);
	JButton loginButton = new JButton("Logga in");
	JLabel welcomeLabel = new JLabel();
	JButton changeBookingButton = new JButton("�ndra bokning");
...
//					flightMap.put("Avgångstid: " + avgangsTid.toString() + " Ankomsttid: " + 
...
//			l.add(15);
			...
			m.put("Info", new BorderPanel(this,"Info", l, "Bakåt", "Framåt"));
			// TODO take info from this.flygBokning
			m.put("Bekr�ftelse", new BorderPanel(this, "Bekr�ftelse", new JLabel("SHHHHPOOOOOOFFF")));
			return m;
